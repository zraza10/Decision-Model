...
* **Person or organization developing model**: Zeeshan Raza, "email", MohammadEbrahim Zamani Mazdeh, "ebrahim_zamani@gwu.edu", Mariam Kurasbediani "mariamkuras@gwu.edu", Abid Shafiullah, `abidshafi@gwu.edu`, 
* **Model date**: August, 2021
* **Model version**: 1.0
* **License**: MIT
* **Model implementation code**: [DNSC_6301_GROUP7_Project.ipynb](https://colab.research.google.com/drive/1uc9-JwlOozhi--wssZ4GhFFYInY9nFxb?usp=sharing)
