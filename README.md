...
* **Metrics used to evaluate your final model**: Training AUC, Validation AUC, Test AUC, Others-to-graduate school AIR, University-to-graduate school AIR, high school-to-graduate school AIR, Female-to-Male AIR, mean_squared_error, roc_auc_score, cross_val_score, accuracy_score.
